"""
binance0310.py — Binance Futures BTCUSDT 永续合约历史 K 线数据下载脚本

使用方法:
  1. 确保已安装依赖: pip install requests pandas
  2. 在您的本地电脑上运行: python binance0310.py
  3. 运行完成后，将生成的 4 个 CSV 文件上传给 Manus

输出文件（保存在脚本同目录下）:
  BTCUSDT_5m.csv   — 5分钟 K线，最近 90 天
...
DOWNLOAD_TASKS = [
    {"interval": "5m",  "days": 90,  "filename": "BTCUSDT_5m.csv"},
